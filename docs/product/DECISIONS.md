...
> **Status:** Active product decision record. `INTENT.md` was approved on September 6, 2026. D-001 through D-007 define the first prototype. Decisions are added here only after explicit product-owner approval.
