...
read-only voice, mandatory fixed three-arm Searchlight, or a specific Focus/
...
| D-104 | Canvas, Searchlight and concurrent voice form the first useful release | Earlier slices are checkpoints, not substitute MVPs |
